...
2. Development infrastructure
    ...
    Getting development infrastructure like tests, crates, Cargo configuration, and build scripts ready is an important precursor to building features.
...
- `cargo clippy --all-targets --all-features` to run compiler and linter checks
